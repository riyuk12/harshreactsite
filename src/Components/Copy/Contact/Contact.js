            ...
            <div className="Row_heading">
              ...
              <div className="contact_location">
                <div className="contact_location_para">
                  <Image
                    src="./assets/caroselimg/Vector (5).png"
                    alt="locationLogo"
              ...
              <div className="whatsApp_content">
                <Image
                  src="./assets/caroselimg/Clip path group.png"
                  alt="locationLogo"
                  className="contact_location_logo"
                />
                8822403212
              ...
              <div className="whatsApp_content">
                <Image
                  src="./assets/caroselimg/Vector (3).png"
                  alt="locationLogo"
                  className="contact_location_logo"
                />
                info@besst.in
              ...
              <div className="whatsApp_content">
                <Image
                  src="./assets/caroselimg/phone-call-svgrepo-com 1.png"
                  alt="locationLogo"
                  className="contact_location_logo"
                />
                8811963303
