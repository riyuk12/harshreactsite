					...
					<div className='col-md-8'>
						<div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							<h5 className='pb-2 heading'>
								What is CUET EXAM 2023?
							</h5>
							<p className='after-banner-text text-justify'>
								The National Testing Agency conducts the Common
								University Entrance Exam (CUET). Earlier. CUET
								exam 2023 was known as the Central Universities
								Common Entrance Test (CUCET), all over India. In
								India, 45 Central Universities ask for CUET exam
								for admission. CUET exam 2023 allows students to
								take admission to a range of undergraduate,
								integrated, postgraduate, certificate,
								certification, and research programmes. CUET
								exam 2023 is also acknowledged by the majority
								of India's Deemed Universities and other
								governmental institutions.
							</p>{" "}
							<p className='after-banner-text text-justify'>
								During the academic year 2023–2024, all Central
								Universities (CUs) and participating
								Universities in India will take the CUET exam in
								computer-based test (CBT) format. Across India,
								CUET exam 2023 will be conducted in 13 mediums.
							</p>
						</div>
						...
						<div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							<h5 className='pb-2 heading'>
								Why CUET EXAM 2023 is being conducted?
							</h5>
							<p className='after-banner-text text-justify'>
								The Common University Entrance Exam (CUET) will
								provide applicants nationwide, particularly
								those from rural and other distant places, a
								uniform platform, and equitable possibilities.
								Additionally, CUET exam 2023 will improve
								connections with universities. The Applicants
								would be able to participate in the admissions
								process for several Central Universities by
								taking only one examination.
							</p>{" "}
						</div>

						<div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							<h5 className='pb-2 heading'>
								How can students register for CUET EXAM 2023?
							</h5>
							<p className='after-banner-text text-justify'>
								<ul>
									<li>
										{" "}
										For UG- The last date to fill CUET
										application form 2023 is from 09
										February to 12 March 2023.{" "}
									</li>
									<li>
										{" "}
										For PG- CUET PG 2023 application form
										submission last date is on 19th of April
										2023, 5 pm. (Extended date).
									</li>
								</ul>
							</p>{" "}
						</div>
