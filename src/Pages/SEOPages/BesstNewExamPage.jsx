...
function BesstNewExamPage() {
	...
	console.log(param.split("/registration"), "param");
	...
	function formValidation() {
		if (
			...
			if (!whatsappNumber.length) {
				setwhatsappErr("Enter your whatsapp number");
			}
			if (!agree) {
	...
	const onSendOtp = (id) => {
		...
		axios
			...
			.then((response) => {
				...
				console.log("resonse", response.data.ResultCode);
				if (
					response.status == "200" &&
		...
		<>
			<Helmet>
				...
				<meta
					name='description'
					content='
BESST offers CUET Exam Preparation Course Online in India to help students excel in the exam. Expert faculty and comprehensive study materials provided. For Common University Entrance Test (CUET) Course 2023 Enrol Now.
 '
				/>
				<title>CUET Exam Preparation Course Online in India</title>
				<link
					rel='canonical'
				...
				<div className='row no-gutters'>
					<div className='col-md-8 px-lg-5'>
						<div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							<h1 className='heading'>CUET Exam 2023</h1>
							{/* <p className='after-banner-text text-justify'>
								Do you want to get into your dream college but
								your low score in the board exam results is not
								letting you do that. As you are aware that
								earlier admissions to the central universities
								were based on merit according to the score
								secured in the board exam. But even after that
								if you want to fulfil your dreams and not get
								the opportunities then this secret recipe of{" "}
								<b>“CUET Exam 2023”</b> will help you to get
								into your dream college. So without wasting
								time, let's dive deep into the concept of{" "}
								<b>“CUET Exam 2023”</b>.
							</p> */}
						...
						<p>
							Keeping this pattern in mind as instructed by NTA,
							BESST has curated various CUET exam preparation
						...
						<div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							...
							<p className='after-banner-text text-justify'>
								<ul>
									<li className='mt-2'>
										NTA conducts this exam
									</li>
									<li className='mt-2'>
										NTA stands National Testing Agency
									</li>
								</ul>
							</p>
						</div>
						...
						<div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							<h6 className='pb-2 '>A few important points:</h6>
							<p className='after-banner-text text-justify'>
								<table
									class='table table-bordered td'
									style={{
										width: "100%",
						...
						<p className='after-banner-text text-justify'>
							...
							order to get admission to central universities. This
							exam provides central institutions with the ability
							to evaluate students' areas of expertise. The
							challenges that students face when preparing for the
							CUET Exam are either that they do not have enough
							time to prepare for an additional exam or that the
							curriculum appears to be overbearing and they do not
							know what to do. Because of this, we are going to
							introduce you to BESST, which stands for Brahmaputra
							Test Success Support Team. Here, they will assist
						...
						<p className='after-banner-text text-justify'>
							Besst offers a range of courses for CUET Exam i.e.,
							CUET Exam Preparation Course Online in India.{" "}
						</p>
						<ul>
							<li>Free pack</li>
						...
						{/* <div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							<h5 className='pb-2 heading'>What is CUET?</h5>
							<p className='after-banner-text text-justify'>
								<ul>
									<li className='mt-2'>
										CUET stands for Common University
										Entrance Test.
									</li>
									<li className='mt-2'>
										It is an all-India Test and “CUET Exam
										2023” be one of the biggest examinations
										in the country.
									</li>
									<li className='mt-2'>
										This test was introduced in the year
										2022 for admission into all
										Undergraduate, Postgraduate,
										certifications, diplomas, and integrated
										courses in the central universities of
										the country.
									</li>
									<li className='mt-2'>
										Earlier it was known as CUCET which is
										Central Universities Common Entrance
										Test
									</li>
									<li className='mt-2'>
										The <b>“CUET Exam 2023”</b> will be
										considered for all the UG programs that
										will be offered by a number of
              ...
              <li> Logical and Analytical Reasoning</li>
						...
						<ul>
							...
							<ul>
								...
								<p pt-3 after-banner-text text-justify>
									Here, general test includes practice tests,
									mock tests and mock exam which total up to
									4050+ questions.
								</p>
							</ul>
						</ul>
						...
						{/* <div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							<h6 className='pb-2 heading '>
								CUET 2023 Syllabus
							</h6>
							<p className='after-banner-text text-justify'>
								The <b>“CUET Exam 2023”</b> exam consist of a
								language test, domain-specific papers, and a
								general test.
								<br />
								<b>“CUET Exam 2023”</b> examination will be
								comprised of four sections as per the latest
								CUET updates.
								<ul>
									<li className='mt-2'>
										{" "}
									...
									<li className='mt-2'>
										...
										Numerical Ability<br></br>
										Quantitative Reasoning<br></br>
										Logical and Analytical Reasoning
									</li>
								</ul>
								<p className='after-banner-text text-justify'>
									A few important areas that you need to focus
									on while preparing for{" "}
									<b>“CUET Exam 2023”</b> preparation include
									Aptitude, Reasoning, English, General
									Aptitude, Data Interpretation, and
									Analytical Skills.
								</p>
								<ul>
									<li className='mt-2'>
										{" "}
										Don’t forget to work on your General
										Knowledge subjects and topics that are
										relevant to your stream.{" "}
									</li>
									<li className='mt-2'>
										{" "}
										The disciplines for UG applicants
										include Physics, Chemistry, and
										Mathematics, and they are based on the
										answers to the questions in the paper.{" "}
									</li>
								</ul>
								<p className='after-banner-text text-justify'>
									Candidates can choose the combination
									at-most 2 languages and 6 domain-specific
									subjects or 3 languages and 5
									domain-specific tests.{" "}
								</p>
								<p className='after-banner-text text-justify'>
									From now onwards this test will be conducted
									in two slots. The first slot will have a
									duration of 45 to 195 minutes and the second
									slot will have a duration of 45 to 225
									minutes.
								</p>
								<p className='after-banner-text text-justify'>
									Since the coming of the “CUET Exam 2023”
									exam students have got this opportunity to
									fly again but for this to happen, you also
									need to prepare well and give your best with
									proper planning, consistency, and hard-work
									to score well. To be confident in what you
									have prepared and to benefit from your hard
									work you need to work on your concepts.
								</p>
							</p>
						</div> */}
            ...
            <p className="after-banner-text">
             ...
             <a href="#"> besst.in</a>also provides live classes for General Test paper for
              ...
              dream institute.
						...
						<h1 className='heading pt-2'>How BESST helps you?</h1>
						<p pt-3 after-banner-text text-justify>
							BESST provides you the CUET exam preparation course
							online in India. Additionally, they provide the most
							recent news and updates about the various colleges,
							as well as information about the CUET exam. As a
							result, you won't have to waste your valuable time
							scouring the internet for news, articles, and
							anything else associated with it. They will not only
							get you ready for the exam but will also assist you
							to simulate what it would be like to take the exam
							through the CUET exam preparation courses online in
							India.
						</p>
...
Prepare for your CUET (UG) 2023 Online Test by registering for free at<a href="#"> besst.in</a>and grab your seat at your dream institute.
                  ...
                  >
                    Duration
									...
									<tr>
										...
										{examPattern && examPattern.length > 0
                      ...
                      >
						...
						<div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							<h6 className='pb-2 heading '>Conclusion</h6>
							<p className='after-banner-text text-justify'>
								Candidates who want to get admission in
								undergraduate programs must study thoroughly and
								prepare to clear “CUET Exam 2023” to get into
								their dream university and fulfil their dreams.
							</p>
						</div>
...
export default BesstNewExamPage;
