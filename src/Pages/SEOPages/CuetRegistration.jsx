		...
		<>
			<div className='application'>
				<Helmet>
					...
					<meta
						name='keyword'
						content='CUET 2023 Registration Form'
					/>
					<meta
						name='description'
					...
					<link
						rel='canonical'
						href='https://besst.in/registration/blog/2023/dynamic/cuet-registration'
					/>
				</Helmet>
			</div>
			<Header
				...
				<div className='row no-gutters'>
					<div className='col-md-8'>
						<div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							<h5 className='pb-2 heading'>CUET REGISTRATION</h5>
							<p className='after-banner-text text-justify'>
								The CUET Registration has begun from 9th
								February 2023 and will close on 12 March 2023
								(up to 9.00 pm). NTA (National testing Agency)
								has started the CUET Registration process at its
								official website cuet.samarth.ac.in . The CUET
								Registration has begun for admission to
								undergraduate and integrated courses into
								Central Universities and other participating
								universities of the country. The important dates
								and information required to be remembered by the
								candidates are listed as following points:
							</p>{" "}
						</div>

						<div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							<p className='after-banner-text text-justify'>
								The important dates and information required to
								be remembered by the candidates are listed as
								following points:
							</p>{" "}
							<ol>
								<li>
									) The CUET exam will be conducted in the
									Computer Based Test (CBT) mode.
								</li>
								<li>
									Candidates can do online submission of CUET
									2023 Registration between 9 February and 12
									March 2023 (up to 9.00 pm).
								</li>
								<li>
									Candidates can make payments through
									Credit/Debit card/Net banking/UPI. The last
									date of successful transaction of fee is 12
									March 2023 (up to 11.50pm)
								</li>
								<li>
									Correction in particulars of the CUET 2023
									Registration form can be made from 15 March
									to 18 March 2023 (up to 11.50 pm) only.
									After that, no correction will be made.
								</li>
								<li>
									The announcement of the City of examination
									for CUET (UG) 2023 will be done on 30 April
									2023.
								</li>
								<li>
									The candidates can download the admit cards
									from the NTA website from the second week of
									May 2023.
								</li>
								<li>
									The date of CUET (UG) 2023 examination is
									from 21 May 2023 onwards.
								</li>
								<li>
									Display of Recorded Responses and answer
									keys of CUET (UG) 2023 exam will be
									announced later on the website.
								</li>
								<li>
									Declaration of CUET (UG) 2023 result on the
									NTA website will be announced later on the
									website.
								</li>
								<li>
									Candidates must carefully refer and research
									the eligibility requirements of the
									programmes offered by various Central
									universities and participating
									universities/organisations before filling in
									the CUET 2023 Registration form.
								</li>
							</ol>
						</div>
              ...
              mode and no other medium will be entertained.
						...
						<div className='px-5 pt-5 ' style={{ padding: "10px" }}>
							<h5 className='pb-2 heading'>
								Important Instructions for filling in CUET
								REGISTRATION FORM FORM:{" "}
							</h5>
							<p className='after-banner-text text-justify'>
								<ul>
									<li>
										Candidates can apply for the CUET (UG)
										2023 through online mode only on the
										official website cuet.samarth.ac.in. The
										registration form will not be accepted
										in any other mode.
									</li>
									<li>
										Candidate is allowed to fill only one
										CUET 2023 Registration form. Strict
										action will be taken against the
										candidates who have filled more than one
										Registration Form.
									</li>
									<li>
										Candidates need to strictly follow the
										instructions given in the Information
										Bulletin and on the website
										cuet.samarth.ac.in. They will be
										disqualified if they do not comply with
										the guidelines.
									</li>
									<li>
										Candidates e-mail address and mobile
										number provided in the Online
										Registration will be used for
										information and communication. Therefore
										it should be their own or
										Parents/Guardians only.
									</li>
									<li>
										In case of any difficulty, candidates
										may contact 011 - 40759000 / 011 -
										69227700 or e-mail at cuet-ug@nta.ac.in
										during the CUET 2023 (UG) Registration
										process.
									</li>
									<li>
										For the latest updates regarding the
										CUET (UG) 2023 exam, the candidates are
										advised to frequently visit the NTA
										website(s) i.e., www.nta.ac.in and
...
export default CuetRegistration;
