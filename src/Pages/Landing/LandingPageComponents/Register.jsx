...
export default function Register() {
	...
	const [familyName, setFamilyName] = useState(
		location.state?.profileObj.lastname || ""
	);
	...
	useEffect(() => {
		if (
			!location.state?.profileObj.email &&
			location.state?.profileObj.source === "Facebook"
		) {
	...
	async function token(id) {
		...
		//       navigate(studDashboard); was commented already
		//     }
		//   })
		//   .catch((err) => {
		//     console.error(err);
	...
	return (
		<div className='Register'>
			...
			<div className='wrapper' style={{ marginTop: "100px" }}>
				...
				<form className='form-right' style={{ zIndex: 10 }}>
