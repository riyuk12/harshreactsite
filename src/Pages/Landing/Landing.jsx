	...
	return (
		<section className='container-fluid' style={{ padding: 0 }}>
			...
			<div className='container'>
				...
				<div className='row flex-lg-row-reverse align-items-center g-5 pt-5'>
					...
					<div className='col-lg-6'>
						...
						<h3>
							Brahmaputra Exam Success Support Team Private
							Limited
						</h3>
						<p>
							{" "}
							Click below to explore more or register yourself to
							be a part of BESST family.{" "}
						</p>
						<div className='d-grid gap-2 d-md-flex justify-content-md-start'>
							{Cookies.get("token") ? (
								<>
									<a
										type='button'
										className='btn btn-outline-secondary px-4 px-3 ml-4'
										href='#courseUpdate'
									>
										Explore
									</a>
									<Link
										type='button'
										className='btn main-btn  px-4 px-3 ml-4'
										to={"/studentDashboard"}
									>
										Go to Dashboard
									</Link>
						...
						<div className='d-grid gap-2 d-md-flex justify-content-md-start'>
							...
							>
								**NOTE: This portal is compatible with Desktops
								and Laptops only and can be viewed using
								"Desktop Site" option in mobile.
							</span>
						</div>
					</div>
				</div>
						...
						<div className='col-md-12'>
							<ul className='p-0'>
								<li className='ml-5 p-1'>
									...
									<a
										href='https://resultsassam.nic.in/ahsecroll.aspx'
										target='_blank'
									>
										{" "}
										Check here
				...
				<div className='row'>
					<div className='col-md-3 col-sm-6 p-5'>
						<div className='card glass-bg rounded text-center fixed-height-card'>
							...
							<h3 className='white fw-bolder statisticsTeacher'>
								{statistics.totalTeacher}
							</h3>
						</div>
					</div>
					...
					<div className='col-md-3 col-sm-6 p-5'>
						<div className='card glass-bg rounded text-center fixed-height-card'>
							...
							<h3 className='white fw-bolder statisticsStudent'>
					...
					<div className='col-md-3 col-sm-6 p-5'>
						<div className='card glass-bg rounded text-center fixed-height-card'>
							...
							<h3 className='white fw-bolder statisticsCourse'>
					...
					<div className='col-md-3 col-sm-6 p-5'>
						<div className='card glass-bg rounded text-center fixed-height-card'>
							...
							<h3 className='white fw-bolder statisticsMCQ'>
								{statistics.totalMCQ}
							</h3>
						</div>
					</div>
					...
					<div className='row'>
						...
						<div className='col-md-4 col-sm-12 my-auto p-3 text-center'>
							<p>
								<a
									style={{ color: "#2aca2a" }}
									title='Please click here to send whatsapp'
									href='https://wa.me/919365834467'
									target='_blank'
								>
									<BsWhatsapp />
								</a>{" "}
							...
							<p style={{ color: "#7b1fa2" }}>
								...
								Banghorbori, Panjabari <br /> Guwahati-781037{" "}
								<br /> Assam
							</p>
						</div>
						<div className='col-md-4 col-sm-12 main-color-bg'>
							<h2
								className='white text-center m-3'
							...
							<div className='row p-4'>
								<a
									onMouseOver={() => showFaqAns("demo1")}
									onMouseLeave={() => hideFaqAns("demo1")}
							...
							<div className='row p-4'>
								<a
									onMouseOver={() => showFaqAns("demo2")}
									onMouseLeave={() => hideFaqAns("demo2")}
									className='text-decoration-none white'
									style={{ color: "#decaec" }}
								>
									2. For which standard the courses are
									available?
								</a>
								<div
									id='demo2'
									...
									style={{ color: "white" }}
								>
									Currently, we are providing guidance for
									CUET (UG)2022.
								</div>
							</div>
							...
							<div className='row p-4'>
								<a
									onMouseOver={() => showFaqAns("demo3")}
									onMouseLeave={() => hideFaqAns("demo3")}
									className='text-decoration-none white'
									style={{ color: "#decaec" }}
								>
							...
							<div className='row p-4'>
								<a
									...
									style={{ color: "#decaec" }}
								>
									4. How can we contact and report an error,
									if found?
								</a>
								<div
									id='demo4'
									...
									style={{ color: "white" }}
								>
									A student can contact with BESST team on
									given whatsapp number and also via email.
								</div>
							</div>
							<div className='row p-4'>
								<a
								...
								<div
									...
									style={{ color: "white" }}
								>
									Yes, regional language paper like Bengali
									and Assamese are available.
								</div>
							</div>
					...
					<div className='modal-content'>
						...
						<div className='modal-body mx-auto'>
							...
							>
								...
								<span>
									{" "}
									Now, you are successfully registered. Please
			...
			<button
				...
				target='_blank'
			>
				<i className='fa fa-share-alt myfloat' aria-hidden='true'></i>
			</button>
			<br />

			<div className='plane'>
				<button className='scroll-btn--up'>
					<className className='fas fa-location-arrow'></className>
				</button>
			</div>
			...
			<footer className='footer mt-auto py-3 main-color-bg border-top'>
				<div className='container text-center'>
					<span className='white'>
						Copyright &#169; 2022 BESST(Brahmaputra Exam Success
                ...
                <SwiperSlide>
                  ...
                  >
                    ...
                    <div className="card-body">
                      ...
                      <p className="card-text">Skills : {teacher.skills}</p>
...

{
	/* <div className="row">
        <div className="col-md-12 ">
          {" "}
          <h4 className="m-5 underline">DISCLAIMER &nbsp; &nbsp;</h4>
        </div>
        <div className="row" style="padding-left: 3%;">
          <div className="col-md-12 ">
            <div className="col-md-12 ">
              <span>
