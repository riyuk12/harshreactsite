		...
		const fetchPdf = async () => {
			try {
				...
				const pdf = await axios.get(
					baseUrl() + "/pg/getInvoicePdf/" + orderNo,
					{ headers: config, data: {} }
				);
...
const PaymentOrder = memo((props) => {
	...
	useEffect(() => {
		const val = paydata.map((obj) => {
			const date = obj.orderDate.split(" ")[0]
				? obj.orderDate.split(" ")[0]
				: obj.orderDate;
			...
			if (date !== obj.orderDate) {
				...
				const newDate =
					spl.reverse().join("-") +
					" " +
					obj.orderDate.split(" ")[1] +
					" " +
					obj.orderDate.split(" ")[2];
				value = newDate;
				// console.log(value);
			}
					...
					<tbody className='table-group-divider'>
						{paydata.map((paymentVal, i) => (
							<tr>
								...
								<td className='align-middle opacity-50 text-nowrap'>
									Rs. {paymentVal.orderAmt}
								</td>
								<td className='align-middle opacity-50 text-nowrap'>
									{paymentVal.orderDate}
								</td>
								<td className='align-middle opacity-50'>
									{paymentVal.bankRefId}
								</td>
								<td className='align-middle opacity-50 text-nowrap'>
									{paymentVal.packActivatedOn}
								</td>
								<td className='align-middle opacity-50 text-nowrap'>
									{paymentVal.packExpiringOn}
								</td>
								<td className='align-middle opacity-50 '>
									{paymentVal.orderStatus}
								</td>
								<td className='align-middle'>
									<button
										...
										onClick={() =>
											setOrderNo(paymentVal.orderNo)
										}
										data-bs-target={"#ViewInvoiceModal"}
										disabled={
											paymentVal.orderStatus === "Failed"
										}
									>
...
// <tr>
//               <td className="align-middle"></td>
//               <td className="align-middle" style={{ color: "#7b1fa2" }}>
//                 Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, perferendis.
//               </td>
//               <td className="align-middle opacity-50">Sept 5, 2022</td>
//               <td className="align-middle opacity-50">Rs. 0</td>
//               <td className="align-middle opacity-50">Free Coupon</td>
//               <td>
//                 <button className="btn main-btn m-2">Receipt</button>
//               </td>
//             </tr>
//             <tr>
//               <td className="align-middle">{/* <AiOutlineShoppingCart size={20} /> */}</td>
//               <td className="align-middle" style={{ color: "#7b1fa2" }}>
//                 Lorem ipsum dolor s elit. Aperiam, architecto? Commodi sapiente error nihil ducimus.
//               </td>
//               <td className="align-middle opacity-50">Dec 23, 2022</td>
//               <td className="align-middle opacity-50">Rs. 0</td>
//               <td className="align-middle opacity-50">Free Coupon</td>
//               <td className="align-middle">
//                 <button className="btn main-btn m-2">Receipt</button>
