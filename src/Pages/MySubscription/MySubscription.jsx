...
let random =
	"[Details_of_Product] Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit fuga autem maiores necessitatibus.";
const obj = {};
	...
	return (
		<>
			<li className='list-group-item border-2'>
				<h3
					className='my-2 font-weight-bold mx-3'
					style={{ color: "#7b1fa2" }}
				>
					{subscriptionName}
				</h3>
				<div className='media align-items-md-start flex-column flex-column-reverse flex-lg-row p-3'>
					{/* TODO: Details of Courses */}
					<div
						className='media-body order-2 order-lg-1'
						style={{ flexGrow: 2 }}
					>
						<div className='my-4'>
							<p className='text-muted my-1 small'>
								Subscription Plan: {supsPlanName}
							</p>
							<p className='text-muted mb-1 small'>
								Purchase Date: 2022-07-08T11:07:24.000+0000
							</p>
							<p className='text-muted my-1 small'>
					...
					<div className='media-body order-2 order-lg-1'>
						<div className='my-4'>
							...
							<p className='text-muted my-1 small'>Quantity: 1</p>
						</div>
					</div>
					{/* TODO: More Details */}
					<div className='media-body order-2 order-lg-1'>
						<div className='my-4'>
							<p className='text-muted my-1 small'>
								Active On: 2022-07-08
							</p>
							<p className='text-muted my-1 small'>
								Expire On: 2023-07-08
							</p>
						</div>
					</div>
					{/* TODO: DOWNLOAD */}
					<div
						...
						className='ml-lg-0 order-1 order-lg-2'
					>
						<button
							type='button'
