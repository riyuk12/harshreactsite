...
function PaymentConfirmation() {
	...
	return (
		<div>
			...
			<div
				className='d-flex flex-column flex-column-reverse justify-content-around px-3 text-center payment_confirm'
			...
			>
				...
				{status === "internal" && (
					<PaymentError profileData={profileData} orderId={orderId} />
				)}
			</div>
